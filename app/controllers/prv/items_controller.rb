  ...
  class ItemsController < RootController
    ...
    def create
      ...
      respond_to do |format|
        if @prv_item.save
          format.html { redirect_to prv_items_path(@prv_item.id), notice: 'Item was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @prv_item.update(prv_item_params)
          format.html { redirect_to prv_items_path(@prv_item.id), notice: 'Item was successfully updated.' }
